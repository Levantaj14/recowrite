import {Container, Flex, Heading, Image, Link, Stack, Text} from "@chakra-ui/react";
...
function Story() {
    return (
        <motion.div initial={{opacity: 0, y: +100}} animate={{opacity: 1, y: 0}}
            ...
            <Container as="main" mt="4" mb="10" maxW="6xl">
                <Heading size="4xl" pb="4">Exploring the Latest Innovations in Artificial Intelligence</Heading>
                <Flex flexDirection="row" justifyContent="flex-start" mb={5} alignItems="center">
                    <Text textStyle="md" mr={1}>Written by</Text>
                    <HoverCardRoot>
                        <HoverCardTrigger>
                            <Link>@brent_denton</Link>
                        </HoverCardTrigger>
                        <HoverCardContent>
                            <HoverCardArrow/>
                                ...
                                <Stack gap={3}>
                                    <Stack gap="1">
                                        ...
                                        <Text textStyle="sm" color="fg.muted">
                                            One of the first editors of the website.
                                        </Text>
                                    </Stack>
                                </Stack>
                            </Stack>

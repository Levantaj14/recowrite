...
export const StepsItem = React.forwardRef<HTMLDivElement, StepsItemProps>(function StepsItem(props, ref) {
  ...
  return (
    <ChakraSteps.Item {...rest} ref={ref}>
      <Box display="flex" alignItems="center" gap={2} cursor="default" pointerEvents="none">
        <ChakraSteps.Trigger>
...
export const StepsIndicator = React.forwardRef<HTMLDivElement, StepsIndicatorProps>(function StepsIndicator(
  props,
  ref,
) {

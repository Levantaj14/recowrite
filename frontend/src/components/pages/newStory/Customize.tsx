...
import { Checkbox, Field, Fieldset, Heading, HStack, Input, Portal, Textarea, Popover } from '@chakra-ui/react';
...
export default function Customize({ register, errors, isVisible, setValidateFields, setValue }: Readonly<Props>) {

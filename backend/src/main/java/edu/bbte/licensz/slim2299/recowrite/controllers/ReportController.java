...
public class ReportController {
    private final ReportServiceInterface reportsService;
    private final AuthCookieFinder authCookieFinder;
    private final JwtUtil jwtUtil;

    @Autowired
    public ReportController(ReportServiceInterface reportsService, AuthCookieFinder authCookieFinder, JwtUtil jwtUtil) {
